...
public class PsnlInfoMenu extends Menu {//废弃
    ...
    public PsnlInfoMenu(){
        customer = (HotelAdmin) PersonService.getInstance().searchPerson(HotelService.getInstance().getCurrentUser());
    }
    @Override
    public void show() {

        System.out.println("您好，名为"+customer.getUserName()+"的酒店管理员，下面是您的信息：");
        printNowInfo();
